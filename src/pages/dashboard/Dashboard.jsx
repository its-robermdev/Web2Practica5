...
export default function Dashboard() {
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            <div className="mb-8">
                <h1
                    className={`text-3xl font-bold transition-colors ${theme === "dark" ? "text-white" : "text-gray-800"}`}
                >
                    Bienvenido, {user?.displayName || "Usuario"}
                </h1>
                <p
                    className={`mt-2 transition-colors ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}
                >
